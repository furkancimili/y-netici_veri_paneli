import { SidebarService } from '../sidebarUye/sidebar.service';
...
@Component({
  selector: 'app-footerUye',
  templateUrl: './footerUye.component.html',
  styleUrls: ['./footerUye.component.scss'],
  animations: [
    trigger('slide', [
...
export class FooterUyeComponent implements OnInit {
